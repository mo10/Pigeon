...
#define CUSTOM_HID_EP2IN_ADDR                 0x82
#define CUSTOM_HID_EP2IN_SIZE                 64

#define CUSTOM_HID_EP2OUT_ADDR                0x02
#define CUSTOM_HID_EP2OUT_SIZE                64


#define USB_CUSTOM_HID_CONFIG_DESC_SIZ       (9+9+7+7) // Configuration Descriptor 长度
...
/**
  * @}
  */ 
uint8_t (*USBD_HID_EP_OUT_CALLBACK)(USBD_HandleTypeDef *pdev, uint8_t epnum);
